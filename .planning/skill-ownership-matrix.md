...
| # | Skill Name | Primary Agent | Category | Source | Bundle |
|---|------------|---------------|----------|--------|--------|
| 1 | page-cro | UX Researcher | Conversion | Both | cro-suite |
| 2 | signup-flow-cro | UX Researcher | Conversion | CLAUDE.md only | cro-suite |
| 3 | onboarding-cro | UX Researcher | Conversion | CLAUDE.md only | cro-suite |
...
| 19 | ai-seo | UX Researcher | SEO and discovery | Both | seo-suite |
| 20 | programmatic-seo | UX Researcher | SEO and discovery | CLAUDE.md only | seo-suite |
| 21 | site-architecture | UX Researcher | SEO and discovery | CLAUDE.md only | seo-suite |
| 22 | competitor-alternatives | Customer Success | SEO and discovery | CLAUDE.md only | |
| 23 | schema-markup | UX Researcher | SEO and discovery | CLAUDE.md only | seo-suite |
| 24 | paid-ads | UX Researcher | Paid and distribution | CLAUDE.md only | paid-suite |
| 25 | ab-test-setup | UX Researcher | Paid and distribution | CLAUDE.md only | paid-suite |
| 26 | churn-prevention | UX Researcher | Retention | CLAUDE.md only | |
| 27 | free-tool-strategy | UX Researcher | Growth engineering | CLAUDE.md only | growth-suite |
| 28 | lead-magnets | UX Researcher | Growth engineering | CLAUDE.md only | growth-suite |
| 29 | referral-program | UX Researcher | Growth engineering | CLAUDE.md only | growth-suite |
| 30 | marketing-ideas | CMO | Strategy | Both | strategy-core |
| 31 | marketing-psychology | CMO | Strategy | Both | strategy-core |
| 32 | launch-strategy | CMO | Strategy | Both | |
| 33 | pricing-strategy | CMO | Strategy | Both | |
| 34 | content-strategy | CMO | Strategy | Both | |
| 35 | customer-research | Customer Success | Strategy | Both | |
| 36 | product-marketing-context | CMO | Strategy | CLAUDE.md only | |
| 37 | anthropic-skills:marketing-strategy-pmm | CMO | Strategy | Both | |
| 38 | revops | Customer Success | Sales and RevOps | CLAUDE.md only | sales-suite |
| 39 | sales-enablement | Customer Success | Sales and RevOps | Both | sales-suite |
| 40 | claude-blog:blog-write | Technical Writer | Blog engine | Both | blog-engine |
| 41 | claude-blog:blog-rewrite | Technical Writer | Blog engine | Both | blog-engine |
| 42 | claude-blog:blog-analyse | Technical Writer | Blog engine | CLAUDE.md only | blog-engine |
| 43 | claude-blog:blog-seo-check | Technical Writer | Blog engine | CLAUDE.md only | blog-engine |
| 44 | claude-blog:blog-strategy | Technical Writer | Blog engine | CLAUDE.md only | blog-engine |
| 45 | claude-blog:blog-repurpose | Technical Writer | Blog engine | Both | blog-engine |
| 46 | pdf | Software Engineer | Documents | CLAUDE.md only | document-tools |
| 47 | docx | Software Engineer | Documents | CLAUDE.md only | document-tools |
| 48 | xlsx | Software Engineer | Documents | CLAUDE.md only | document-tools |
| 49 | pptx | Software Engineer | Documents | CLAUDE.md only | document-tools |
...
| 64 | positioning-basics | CMO | Strategy | contentfpz only | strategy-core |
...
| Agent | Existing Paperclip Skills | New Standalone Skills | New Bundled Files | Total Skill Files | Under Cap? |
|-------|--------------------------|----------------------|-------------------|-------------------|------------|
| CEO | 7 | 0 | 0 | 7 | Yes |
...
**CMO (10 files = 3 existing + 7 new):**
Existing: brand-identity.md, competitive-tracking.fallback.md, market-analysis.fallback.md
...
New standalone: competitor-alternatives, customer-research, testimonial-collector, ai-discoverability-audit, case-study-builder
New bundles: research-suite (reddit-insights, youtube-summarizer, last30days, daily-briefing-builder), sales-suite (revops, sales-enablement)

**UX Researcher (9 files = 3 existing + 6 new):**
...
New bundle: document-tools (pdf, docx, xlsx, pptx, frontend-slides)

**CEO (7 files = 7 existing + 0 new):**
Existing only: auto-assign.fallback.md, backlog-health.fallback.md, brand-identity.fallback.md, competitive-tracking.fallback.md, market-analysis.fallback.md, stall-detection.md, vision-workshop.md

**Product Owner (4 files = 4 existing + 0 new):**
Existing only: auto-assign.md, backlog-health.md, market-analysis.fallback.md, product-review.md

**Code Reviewer (1 file = 1 existing + 0 new):**
Existing only: code-review.md

**CTO (0 files):**
No skills. Architecture and standards via agent instructions only.
...
| Bundle Name | Agent | Contains | Skill Count | File Count |
|-------------|-------|----------|-------------|------------|
...
| paid-suite | UX Researcher | paid-ads, ab-test-setup | 2 | 1 |
| strategy-core | CMO | marketing-ideas, marketing-psychology, marketing-principles, positioning-basics, content-idea-generator | 5 | 1 |
| research-suite | Customer Success | reddit-insights, youtube-summarizer, last30days, daily-briefing-builder | 4 | 1 |
| sales-suite | Customer Success | revops, sales-enablement | 2 | 1 |
| document-tools | Software Engineer | pdf, docx, xlsx, pptx, frontend-slides | 5 | 1 |

**Total bundled skills:** 44 (across 11 bundles)
**Total standalone skills:** 27
**Total skill files (bundles + standalone):** 38 new files across all agents

## Unmapped Skills Check

- Count of skills in inventory: 71
- Count of skills in matrix: 71
- Unmapped skills: None
- Duplicate assignments (skill in 2+ agents): None

**Verification method:** Every row number in the matrix (1-71) corresponds to a row in the skill inventory. All 71 inventory skills appear exactly once in the matrix table above.

## Open Questions Resolved

1. **Document creation skills (pdf, docx, xlsx, pptx, frontend-slides)** -- Assigned to Software Engineer, bundled as document-tools. Software Engineer has capacity (2 existing + 1 bundle = 3 total files) and document generation is a technical execution task.

2. **Sales skills (cold-email, revops, sales-enablement)** -- cold-email assigned to LinkedIn Growth Director (pairs with outreach skills: cold-outreach-sequence, meeting-prep). revops and sales-enablement assigned to Customer Success, bundled as sales-suite (client-facing revenue operations).

3. **Skill count** -- Confirmed at 71 by the Plan 01-01 audit. The ROADMAP's "73" was an overcount. The inventory reconciled 22 shared + 28 CLAUDE-only + 21 contentfpz-only = 71 unique skills.

4. **CEO fallback skills** -- Excluded from the 71-skill inventory. CEO's 7 existing Paperclip skills are infrastructure/fallback, not content skills. They count toward the 10-file cap (CEO at 7/10) but are not part of the ownership matrix's 71-skill assignment.

5. **Existing Paperclip skills** -- Listed separately in the inventory's "Existing Paperclip Agent Skills" section. They count toward the 10-file cap per agent but are not part of the 71 content/marketing skills being assigned. The cap impact is reflected in the Agent Skill Counts table above.
